...
<form action="new_topic.php?parent=<?php echo $id; ?>" method="post">
	<label for="title">Title</label><input type="text" size="80" name="title" id="title"  /><br />
    ...
    <textarea name="message" id="message" cols="120" rows="30"></textarea><br />
...
?>
		...
		<div class="foot"><a href="../index.php">Return to Main Web Site</a></div>
	</body>
</html>
<?php
}
